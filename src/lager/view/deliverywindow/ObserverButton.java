...
public class ObserverButton extends JButton implements Observer {
	...
	public void update(Observable o, Object arg) {
		if (o instanceof ObservableKeyListener) {
			/*
			 * Wenn das Observable ein KeyListener ist, wird bei dem Feld Menge überprüft,
			 * ob die Eingabe valide (nur Zahlen) ist. Falls ja, wird dieser Button
			 * aktviert, andernfalls deaktiviert
			 */
			...
			/*
			 * Wenn das Observable ein ObservableStack ist, wird der Button aktiviert,
			 * solange der Stack gefüllt ist. Dies ist im Buchungsdialog der Fall, um Zurück
			 * drücken zu können, oder nicht.
			 */
			this.setEnabled(!((ObservableStack) o).isEmpty());
		} else if (o instanceof ObservableChangeListener) {
			/*
			 * Wenn das Observable ein ObservableChangeListener ist, wird der Button
			 * aktiviert sobald der Buchungsumfang aufgeteilt wurde (Iteration 1 - 4) oder
			 * wenn in Iteration 5 der gesamte restliche Buchungsumfang ausgewählt wurde
			 */
